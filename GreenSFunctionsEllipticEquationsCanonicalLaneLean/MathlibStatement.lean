...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "green-functions-elliptic-equations-canonical-lane",
  theoremObject := "Green's Functions for Elliptic Equations",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, GreenFunctionsEllipticEquationsClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact green_functions_elliptic_equations_endgame A
